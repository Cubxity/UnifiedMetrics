...
class WorldCollection(bootstrap: UnifiedMetricsBukkitBootstrap) : MetricCollection {
    override val collectors: List<MetricCollector> = listOf(WorldCollector(bootstrap))
}