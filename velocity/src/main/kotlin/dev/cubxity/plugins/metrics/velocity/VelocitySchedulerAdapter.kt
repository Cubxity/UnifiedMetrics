...
class VelocitySchedulerAdapter(private val bootstrap: UnifiedMetricsVelocityBootstrap) : AbstractJavaScheduler() {
    override val sync: Executor = Executor {
        bootstrap.server.scheduler.buildTask(bootstrap, it).schedule()
    }
}