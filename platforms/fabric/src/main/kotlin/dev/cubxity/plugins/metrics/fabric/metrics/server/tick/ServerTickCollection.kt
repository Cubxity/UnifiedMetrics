...
package dev.cubxity.plugins.metrics.fabric.metrics.server.tick
...
class ServerTickCollection : CollectorCollection {
    ...
    override fun initialize() {
        TickEvent.event.register { duration ->
            tickDuration += duration / MILLISECONDS_PER_SECOND
        }
    }
}