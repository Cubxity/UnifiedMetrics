...
class ServerWorldFSCollection(bootstrap: UnifiedMetricsFabricBootstrap) : CollectorCollection {
    override val collectors: List<Collector> = listOf(ServerWorldFSCollector(bootstrap))
